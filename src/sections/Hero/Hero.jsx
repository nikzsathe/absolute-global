      ...
      <div className="ag-hero__content">
        <div className="ag-hero__inner">
          ...
          <h1 className="ag-hero__title">
            <span className="ag-hero__line ag-anim" style={{ '--agd': '450ms' }}>Illuminating Brands,</span>
            <span className="ag-hero__line ag-hero__line--outline ag-anim" style={{ '--agd': '600ms' }}>Unveiling Their</span>
            <span className="ag-hero__line ag-anim" style={{ '--agd': '750ms' }}>Stories Step by Step.</span>
          </h1>
        ...
        <div className="ag-hero__bottom ag-anim" style={{ '--agd': '1100ms' }}>
          <p className="ag-hero__tagline">
            End-to-end sales enablement — from database management to appointment setting.
          </p>
