...
const TermsConditions = () => {
  ...
  React.useEffect(() => {
    ...
    link.rel = 'stylesheet';
    link.href = '/pagecss/terms-conditions/assets/css/style.css';
  ...
  return (
    <>
      ...
      <header id="header" className="fixed-top d-flex align-items-center">
          <div className="container d-flex align-items-center">
            ...
            <nav className="nav-menu d-none d-lg-block">
              <ul>
                <li className="active"><a href="#">Terms and conditions</a></li>
      ...
      <h2>Welcome to Absolute Global Outsourcing!</h2><br />
      <p>These terms and conditions outline the rules and regulations for the use of Absolute Global Outsourcing' Website, located at absolute-global.com. By accessing this website, you agree to these terms and conditions. Please do not continue to use absolute-global.com if you do not agree with all of the terms and conditions stated on this page.</p>
      ...
      <ol>
            ...
            <li>We or our service providers also use analytic services to help us understand how effective our content is, what interests our users have, and to improve how this Website works. In addition, we use web beacons or tracking pixels to count visitor numbers and performance cookies to track how many individual users access this Website and how often. Generated by Termzy.io. This information is used for statistical purposes only and it is not our intention to use such information to personally identify any user.</li>
                  <li>The cookies collected are used to a very limited extent necessary for technical purposes (website functionality) and stored for 1 to 5 years in line with the international NAI standards.</li>
            <li>The browsers of most computers, smartphones, and other web-enabled devices are typically set up to accept cookies. If you wish to amend your cookie preferences for this website or any other websites you can do this through your browser settings. Your browser’s ‘help’ function will tell you how to do this. Be aware that disabling cookies will affect the functionality of this website in areas in which cookies are necessary for the functioning of features, and usually results in also disabling certain functionalities and features on this site. Therefore, it is recommended that you do not disable cookies.</li>
      
            </ol>
            
            <h2>License and Intellectual Property Rights</h2>
            
              <p>Unless otherwise stated, Absolute Global Outsourcing Private Limited, and/or its licensors own the intellectual property rights for all material on absolute-global.com. This website and its contents are protected by copyright, trademark, and other laws of India, and/or foreign countries. We and our licensors reserve all rights not expressly granted under these Terms of Use.
              ...
              <li>Republish material from absolute-global.com;</li>
              <li>Use material from absolute-global.com for commercial purposes;</li>
              <li>Sell, rent, or sub-license material from absolute-global.com;</li>
              <li>Reproduce, duplicate, modify or copy material from absolute-global.com;</li>
              <li>Redistribute content from absolute-global.com.</li>
              </ol>
            <p>You shall not use the "Absolute Global Outsourcing Private Limited" name or the Absolute Global Outsourcing Private Limited logo, either alone or in combination with other words or design elements. You may not use any of the foregoing names, marks, or logos in any press release, advertisement, or other promotional or marketing material or media, whether in written, oral, electronic, visual, or any other form, except if expressly permitted in writing by Absolute Global Outsourcing Private Limited.
      ...
      You will comply with all applicable laws in accessing and using this Website.
            ...
            <h2>Your Privacy</h2>
            <p>You acknowledge that we may use your personal information and data according to our Privacy Policy incorporated herein by this reference. You hereby agree to the terms of our Privacy Policy, including any obligations imposed on you therein.</p>
      ...
      You can reach out to our Data Protection Officer or email us at contact@absolute-global.com if you want to access, amend, delete or limit the use or disclosure of your data gathered by Absolute Global Outsourcing Private Limited.
              ...
              <h2>Removal of links or contents from our website</h2>
              <p>If you find any link, media or contents on our website that is offensive or any of your copyrighted media used for any reason, you are free to contact and inform us at any moment. We will consider requests to remove those things, but we are not obligated to or so or to respond to you directly.</p>
       ...
       <p>Your use of this website is at your own risk and you assume full responsibility and risk of loss resulting from your usage, including, without limitation, with respect to loss of service or data. We will not be liable for any direct, indirect, special, incidental, consequential, or punitive damages or any other damages whatsoever, whether in an action of contract, statute, tort (including, without limitation, negligence), or otherwise, relating to or arising out of the use of this website, even if we knew, or should have known, of the possibility of such damages.
         ...
         <p> The above disclaimers and limitations of liability shall be applicable not only to us but also to our personnel and subcontractors.</p>
